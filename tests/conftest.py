...
from nevermind_metadata.run import app
...
json_dict = json.loads(urlopen(
    "https://raw.githubusercontent.com/keyko-io/nevermind-docs/master/architecture/specs/examples/access/v0.1/ddo1.json").read().decode('utf-8'))

json_dict2 = json.loads(urlopen(
    "https://raw.githubusercontent.com/keyko-io/nevermind-docs/master/architecture/specs/examples/access/v0.1/ddo1-upsert.json").read().decode('utf-8'))
...
json_before = json.loads(urlopen(
    "https://raw.githubusercontent.com/keyko-io/nevermind-docs/master/architecture/specs/examples/access/v0.1/ddo2.json").read().decode('utf-8'))
json_update = json.loads(urlopen(
    "https://raw.githubusercontent.com/keyko-io/nevermind-docs/master/architecture/specs/examples/access/v0.1/ddo2-update.json").read().decode('utf-8'))

json_valid = json.loads(urlopen(
    "https://raw.githubusercontent.com/keyko-io/nevermind-docs/master/architecture/specs/examples/metadata/v0.1/metadata1.json").read().decode('utf-8'))
